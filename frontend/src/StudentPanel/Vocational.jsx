    ...
    const handleNavigate = async () => {
        ...
        try {
            ...
            const combinedData = {
                ...
                subject1: (scores[0]?.subject ? String(scores[0].subject) : '').toUpperCase(),
                subject1Marks: String(scores[0]?.obtained || ''),
                subject2: (scores[1]?.subject ? String(scores[1].subject) : '').toUpperCase(),
                subject2Marks: String(scores[1]?.obtained || ''),
                subject3: (scores[2]?.subject ? String(scores[2].subject) : '').toUpperCase(),
                subject3Marks: String(scores[2]?.obtained || ''),
                subject4: (scores[3]?.subject ? String(scores[3].subject) : '').toUpperCase(),
                subject4Marks: String(scores[3]?.obtained || ''),
                subject5: (scores[4]?.subject ? String(scores[4].subject) : '').toUpperCase(),
                subject5Marks: String(scores[4]?.obtained || ''),
                subject6: (scores[5]?.subject ? String(scores[5].subject) : '').toUpperCase(),
