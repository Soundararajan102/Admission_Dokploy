    ...
    const handleNavigate = async () => {
        ...
        try {
            ...
            const combinedData = {
                ...
                subject2: String(scores[0].subject).toUpperCase(),
                subject2Marks: String(scores[0].obtained),
                subject3: String(scores[1].subject).toUpperCase(),
                subject3Marks: String(scores[1].obtained),
                subject4: String(scores[2].subject).toUpperCase(),
                subject4Marks: String(scores[2].obtained),
                subject5: String(scores[3].subject).toUpperCase(),
                subject5Marks: String(scores[3].obtained),
                subject6: String(scores[4].subject).toUpperCase(),
                subject6Marks: String(scores[4].obtained),
